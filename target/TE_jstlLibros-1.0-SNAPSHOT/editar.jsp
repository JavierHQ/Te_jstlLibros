        ...
        <form action="Controller"  method="post">
            ...
            <table>
                ...
                <tr>
                    <td>MEDIO:</td>
                    <td>
                        <input type="radio" name="medio" value="Fisico" <c:if test="${miLibro.medio=='Fisico'}" var="res" scope="request">checked</c:if>/>Fisico
                            <br>
                            <input type="radio" name="medio" value="Magnetico" <c:if test="${miLibro.medio=='Magnetico'}" var="res" scope="request">checked</c:if>/>Magnetico
                    </tr>   
                    <tr>
                        <td>
